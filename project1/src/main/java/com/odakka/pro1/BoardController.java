...
public class BoardController {
	...
	//http://localhost:8080/pro1/detail?bno=214
	//파라미터로 들어오는 값 잡기
	...
	public String write(HttpServletRequest request) {
		...
		dto.setBwrite("햄우롸비법전"); // 이건 임시로 적었습니다. 로그인 추가되면 변경하겠습니다.
	...
	//삭제가 들어온다면 http://172.3.1.19/delete?bno=150
